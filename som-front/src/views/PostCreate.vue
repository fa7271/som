  ...
  <div class="container">
    ...
    <div class="post-content-container">
      ...
      <div v-else>
        <div class="form-group">
          <label>게시글 내용:</label>
          <ckeditor :editor="editor" v-model="editedContent" :config="editorConfig"></ckeditor>
        </div>
      </div>
    </div>
    ...
    <div class="comment-section">
      <div class="form-container">
        <form @submit.prevent="commentCreate" class="form-row align-items-end">
          ...
          <div class="col-auto">
            <button type="submit" class="btn btn-primary custom-btn" :disabled="!comment.trim()">등록</button>
          </div>
        </form>
      </div>
